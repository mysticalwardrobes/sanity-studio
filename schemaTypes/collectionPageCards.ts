  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        cardSelectionField('blackTie', 'Black Tie'),
        cardSelectionField('brandPrEvents', 'Brand & PR Events'),
        cardSelectionField('bridesmaidWeddingGuests', 'Bridesmaid & Wedding Guests'),
        cardSelectionField('buwanNgWika', 'Buwan ng Wika'),
        cardSelectionField('concert', 'Concert'),
        cardSelectionField('corporateFunctions', 'Corporate Functions'),
        cardSelectionField('culturalEvents', 'Cultural Events'),
        cardSelectionField('debutBirthdays', 'Debut & Birthdays'),
        cardSelectionField('eveningGala', 'Evening Gala'),
        cardSelectionField('frameHerPhotoshoots', 'Frame Her & Photoshoots'),
        cardSelectionField('graduation', 'Graduation'),
        cardSelectionField('intimatePartiesDateNights', 'Intimate Parties & Date Nights'),
        cardSelectionField('oathTaking', 'Oath Taking'),
        cardSelectionField('pageants', 'Pageants'),
        cardSelectionField('pageantsCompetitions', 'Pageants & Competitions'),
        cardSelectionField('photoshoot', 'Photoshoot'),
        cardSelectionField('photoshoots', 'Photoshoots'),
        cardSelectionField('sagalaFloresDeMayo', 'Sagala & Flores de Mayo'),
        cardSelectionField('sagalaFloresDeMayoSlash', 'Sagala / Flores de Mayo'),
        cardSelectionField('themedEvents', 'Themed Events'),
        cardSelectionField('promGrandBalls', 'Prom & Grand Balls'),
        cardSelectionField('promGrandBall', 'Prom & Grand ball'),
        cardSelectionField('specialGuestsPixieDresses', 'Special Guests & Pixie Dresses'),
      ],
    }),
    defineField({
      name: 'cultural',
